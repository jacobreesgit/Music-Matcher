...
struct CustomMusicPickerView: View {
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: AppSpacing.small) {
                    ...
                    HStack(spacing: AppSpacing.medium) {
                        ...
                        // Song Count
                        Text("\(viewModel.displayedSongsCount) songs")
                            .font(AppFont.caption)
                            .foregroundColor(Color.designTextSecondary)
                        ...
                        // Group Picker
                        Menu {
                            ForEach(MusicLibraryViewModel.GroupingMode.allCases, id: \.self) { mode in
                                Button(action: {
                            ...
                            HStack(spacing: 4) {
                                Image(systemName: "square.grid.3x1.folder.badge.plus")
                                    .font(AppFont.iconSmall)
                                Text("Group: \(viewModel.groupingMode.displayName)")
                                    .font(AppFont.caption)
                            }
                            .foregroundColor(Color.designPrimary)
                        }
    ...
    private var songListView: some View {
        ScrollView {
            LazyVStack(spacing: 0, pinnedViews: .sectionHeaders) {
                ForEach(viewModel.groupedSongs(), id: \.key) { group in
    ...
    private func sectionHeader(_ title: String) -> some View {
        ...
        .background(Color.designBackground.opacity(0.95))
    }
...
struct CustomMusicPickerView_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            CustomMusicPickerView(title: "Select Source Track") { _ in }
                .previewDisplayName("Light Mode")
            
            CustomMusicPickerView(title: "Select Target Track") { _ in }
